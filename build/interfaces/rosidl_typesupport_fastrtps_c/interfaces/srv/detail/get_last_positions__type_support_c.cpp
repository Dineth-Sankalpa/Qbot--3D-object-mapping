  ...
  void * untyped_ros_message)
{
  ...
  _GetLastPositions_Request__ros_msg_type * ros_message = static_cast<_GetLastPositions_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: num_positions
  {
    cdr >> ros_message->num_positions;
  }
  ...
  // Field name: positions
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces, msg, Position
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _GetLastPositions_Response__ros_msg_type * ros_message = static_cast<_GetLastPositions_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: positions
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
